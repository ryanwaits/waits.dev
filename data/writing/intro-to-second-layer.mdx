...
image: '/static/images/intro-second-layer/list-view.png'
---
...
At its core, Second Layer simplifies the process of integrating and working with smart contracts on the Stacks blockchain. It eliminates the need for complex and time-consuming UI development tasks for commonly used smart contracts, allowing you to focus on the core functionalities of your application.
